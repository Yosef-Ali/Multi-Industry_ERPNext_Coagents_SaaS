					...
					handler: async ({
						...
						try {
							...
							return {
								...
								next_steps: ['Mark attendance', 'Assign to courses', 'Generate report card'],
							};
						} catch (error: any) {
							return {
								success: false,
					...
					parameters: [
						{
							...
							type: 'string',
							description:
								'Type of report: attendance_summary, grade_report, fee_collection, student_list',
							required: true,
						},
						{
							name: 'filters',
					...
					handler: async ({ patient_name, date_of_birth, contact, blood_group }: any) => {
						try {
							...
							return {
								...
								next_steps: ['Schedule appointment', 'Add medical history', 'Create prescription'],
							};
						} catch (error: any) {
							return {
								success: false,
