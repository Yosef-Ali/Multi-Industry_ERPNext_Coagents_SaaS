...
export async function POST(req: NextRequest) {
	...
	const OPENROUTER_HTTP_REFERER =
		env.OPENROUTER_HTTP_REFERER || req.headers.get('referer') || 'http://localhost:3000';
	const OPENROUTER_APP_TITLE = env.OPENROUTER_APP_TITLE || 'ERPNext Developer Assistant';
