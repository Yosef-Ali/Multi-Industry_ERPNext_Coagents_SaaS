          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-lg bg-muted p-4">
              <p className="text-sm text-muted-foreground">
                <strong>Note:</strong> The full chat interface requires database configuration for authentication.
                All the UI components are 100% copied and working as shown here!
              </p>
            </div>
          </CardContent>
        </Card>
