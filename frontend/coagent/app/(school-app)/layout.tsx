...
import { BookOpen, Calendar, FileText, LayoutDashboard, Menu, Settings, Users } from 'lucide-react';
			...
			<div className="flex h-screen bg-gray-50">
				...
				>
					<div className="flex h-full flex-col">
						...
						<div className="flex h-16 items-center justify-between border-b px-6">
							{sidebarOpen && <h1 className="text-xl font-bold text-primary">🎓 School Manager</h1>}
							<button
								type="button"
				...
				<main className="flex-1 flex flex-col overflow-hidden">
					...
					<header className="h-16 border-b bg-white px-6 flex items-center justify-between shadow-sm">
						<div>
							<h2 className="text-2xl font-bold capitalize">{currentPage.replace('-', ' ')}</h2>
							<p className="text-sm text-gray-500">AI-powered school management system</p>
						</div>
