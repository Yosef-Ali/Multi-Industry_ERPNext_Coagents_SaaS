...
import { AlertTriangle, BookOpen, Calendar, CheckCircle, TrendingUp, Users } from 'lucide-react';
		...
		<div className="space-y-6">
			...
			<div className="rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-white">
				...
				<p className="text-blue-100">
					Your AI assistant is ready to help you manage the school efficiently. Try asking: "Show me
					students with low attendance" or "Generate monthly report"
				</p>
			</div>
				...
				<Card className="border-yellow-200 bg-yellow-50">
					<CardHeader>
						<div className="flex items-center gap-2">
							...
							<CardTitle className="text-yellow-900">Attention Required</CardTitle>
						</div>
					</CardHeader>
					<CardContent>
				...
				<Card className="border-green-200 bg-green-50">
					<CardHeader>
						<div className="flex items-center gap-2">
							...
							<CardTitle className="text-green-900">Recent Achievements</CardTitle>
						</div>
					</CardHeader>
					<CardContent>
			...
			<div className="rounded-lg border-2 border-dashed border-primary/30 bg-primary/5 p-6 text-center">
				<h3 className="text-lg font-semibold mb-2 text-primary">💡 Try the AI Assistant</h3>
				<p className="text-sm text-muted-foreground mb-4">
					Click the chat icon in the bottom right to open your AI assistant. It understands this
					dashboard and can help you with any task!
				</p>
