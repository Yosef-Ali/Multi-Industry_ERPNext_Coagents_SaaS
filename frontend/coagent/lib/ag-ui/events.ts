...
import type { AGUIEvent, AGUIRenderedUI, AGUISessionState, AGUIStateDelta } from './types';
import { extractMessageContent, extractStateDelta, extractToolCall } from './types';
...
export class AGUIEventHandler {
	 ...
	 */
	private handleTextMessageEnd(_event: any) {
	 ...
	 */
	private handleRenderUIEnd(_event: any) {
