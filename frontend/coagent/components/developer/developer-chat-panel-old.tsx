            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500">
                        Ask anything about your ERPNext build.
                    </p>
                </div>
            </div>
    ...
    return (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white/80 p-10 text-center shadow-sm">
            ...
            <p className="mt-2 text-sm text-slate-500">
                Ask for code, workflows, DocTypes, or automation strategies. The assistant will
                respond with three implementation variants every time.
            </p>
            <Button
                onClick={onNewChat}
