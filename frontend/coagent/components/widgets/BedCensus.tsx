...
import { Activity, AlertCircle, BedDouble, User, Calendar } from 'lucide-react';
    ...
    return (
        <div className="w-full space-y-4">
            ...
            <div className="text-sm text-gray-600 flex items-center gap-2">
                ...
                <span>Census Report: <span className="font-semibold">{formatDate(reportDate)}</span></span>
            </div>
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col items-end gap-1">
                                            <span className={`px-3 py-1 rounded-full text-white text-sm font-medium ${occupancyBadge.color}`}>
                                                {ward.occupancy_rate}%
                                            </span>
                                            <span className="text-xs text-gray-500">{occupancyBadge.label} Occupancy</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="text-right text-sm">
                                                    ...
                                                    <div className="text-gray-500 mt-1">
                                                        {patient.age && patient.gender && (
                                                            <div>{patient.age}y, {patient.gender[0]}</div>
                                                        )}
