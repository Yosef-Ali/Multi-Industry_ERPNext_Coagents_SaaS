...
export function InventoryHeatmap({
    ...
    return (
        <div className="w-full space-y-4">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                                                    {item.item_name.length > 20 ? item.item_name.slice(0, 20) + '...' : item.item_name}
                                                    <br />
            ...
            {/* Reorder Alerts */}
            {showReorderAlerts && items.filter(i => getStockLevel(i) === 'critical' || getStockLevel(i) === 'out').length > 0 && (
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-red-700">
                                    {items.filter(i => getStockLevel(i) === 'critical' || getStockLevel(i) === 'out').length} items need immediate attention
                                </p>
                            </div>
                        </div>
                    </div>
