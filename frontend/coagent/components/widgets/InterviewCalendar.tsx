...
export function InterviewCalendar({
    ...
    const displayInterviews = useMemo(() => {
        if (selectedDate) {
            return [[selectedDate, interviews.filter(i => i.scheduled_date === selectedDate)]] as [string, Interview[]][];
        }
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between gap-4">
                                                    ...
                                                    <div className="flex flex-col items-end gap-2">
                                                        ...
                                                        {onReschedule && interview.status !== 'completed' && interview.status !== 'cancelled' && (
                                                            <button
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
