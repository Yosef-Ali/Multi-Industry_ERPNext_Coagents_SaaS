  ...
  hotel: [
    {
      ...
      description: 'Visualises room availability by floor with occupancy stats for front-desk teams.',
  ...
  manufacturing: [
    {
      ...
      exampleUsage:
        "<BOMTree data={bomData} onSelectItem={setSelectedComponent} />",
