...
import { type UseCopilotConfig, useCopilot } from '../hooks/useCopilot';
				...
				<div className="flex items-center justify-between border-b border-gray-200 bg-primary-600 px-4 py-3 text-white">
					<div className="flex items-center gap-2">
						...
						<div>
							...
							{config.docName && <p className="text-xs text-primary-100">{config.docName}</p>}
						</div>
					</div>
				...
				<div className="border-b border-gray-200 bg-gray-50 px-4 py-2">
					<div className="flex items-center justify-between text-xs">
						...
						{copilot.messages.length > 0 && (
							<button onClick={copilot.clearMessages} className="text-gray-600 hover:text-gray-800">
								Clear
							</button>
						)}
					</div>
				...
				{copilot.error && (
					<div className="border-b border-red-200 bg-red-50 px-4 py-3">
						<div className="flex items-start justify-between gap-2">
							...
							<button onClick={copilot.clearError} className="text-red-600 hover:text-red-800">
				...
				<div className="border-t border-gray-200 bg-white p-4">
					<div className="flex gap-2">
						...
						<button
							...
							disabled={
								!inputValue.trim() || copilot.connectionState !== 'connected' || copilot.isLoading
							}
