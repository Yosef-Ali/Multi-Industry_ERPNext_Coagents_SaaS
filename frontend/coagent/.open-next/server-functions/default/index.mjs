...
var __reExport = (target, mod3, secondTarget) => (
	__copyProps(target, mod3, 'default'), secondTarget && __copyProps(secondTarget, mod3, 'default')
);
...
var OpenNextNodeResponse = class extends Transform {
	...
	_flush(callback) {
		...
		if (
			bodyLength === 0 && // We use an env variable here because not all aws account have the same behavior
